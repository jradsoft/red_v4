...
<xsl:template match="//cfd:Comprobante">
   ...
   <body background="fondo.jpg">
     ...
     <table width="100%" border="0">
       <tr>
         ...
         <td>
           <center>           
            <img src="letras.jpg" height="80" align="300"/>
           </center>
         </td>
  ...
  <br></br>
		...
		<table border="0">
		 <tr>
		 <td>
       <img src="imagen.jpg" height="100" align="1000"/>
		 </td>
     </tr>
		 </table>
         </center>
...
<tr>
	<td width="100%">
		...
		Tel./Fax 012717125589/ 271-7176283
...
<tr>
	<td width="100%">
		...
		e-Mail: tallerpebsa10@prodigy.net.mx, pbarriga@prodigy.net.mx, tpebsa@prodigy.net.mx
